...
//
// Purpose: Helper to display various hmd stats via Text
//
//=============================================================================

using UnityEngine;
using UnityEngine.UI; // Updated to use UI.Text
using Valve.VR;

public class SteamVR_Stats : MonoBehaviour
{
    public Text text; // Updated to use UI.Text
    ...
    void Awake()
    {
        if (text == null)
        {
            text = GetComponent<Text>(); // Updated to use UI.Text
            text.enabled = false;
        }
